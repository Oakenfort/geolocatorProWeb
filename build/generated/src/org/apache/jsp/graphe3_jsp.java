...
public final class graphe3_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (Smartphone s : smartphoneService.findAll()) {
      ...
      out.write("                            datasets: [{\n");
      out.write("                                    data: [");
 for (Position p : positionService.findAll()) { for (Smartphone s : smartphoneService.findAll()) {
      out.write("\n");
      out.write("                                 ");
      out.print( positionService.nbrPositionParSmartParMois(s.getImei(),new java.sql.Date(p.getDate().getTime())));
      out.write("\n");
      out.write("                                     ,");
 }}
      out.write("0],\n");
      ...
      out.write("                                    label:\"nombre des positions par smartphone par mois\"\n");
      out.write("\n");
      out.write("                                }]\n");
      out.write("                },\n");
      out.write("                \n");
