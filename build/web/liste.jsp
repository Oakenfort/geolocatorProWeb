<%-- 
    Document   : liste
    Created on : 17 déc. 2021, 11:25:42
    Author     : arapt
--%>
	...
	<div class="whole-wrap pb-100">
		<div class="container">
			...
			<br>
				...
				<h3 class="mb-30">lISTE DES SMARTPHONES</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							<div class="serial">#</div>
							<div class="country">IMEI</div>
							<div class="visit">PROPRIETERE</div>
							<div class="percentage">OPTIONS</div>
						</div>
            ...
            %>
            				...
            				<div class="table-row">
					<div class="serial"></div>
					<div class="visit"> <%=p.getImei()%></div>
					<div class="visit"><%=p.getUser() %>  </div>
					<div class="percentage">
					<a href="details.jsp?id=<%=p.getId()%>" class="genric-btn info">Info</a>
					</div>
					</div>
						<%} %>
                                        </div>
