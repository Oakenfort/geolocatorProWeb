<%-- 
    Document   : details
    Created on : 17 déc. 2021, 11:38:31
    Author     : arapt
--%>
...
<body>
	...
	<div class="whole-wrap pb-100">
			...
			<center>
			<p>bilan d'activité du smartphone <%=id%></p>
			...
			<br>
			<br>
			<a href="liste.jsp" class="genric-btn info">menu principal</a>
			<br>
			</center>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        ...
        Position P1 =  ps.findById(id);  %>
			var marker = L.marker([<%=P1.getLatitude()%>,<%=P1.getLongitude()%> ]).addTo(mymap);	
